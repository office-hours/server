...
/**
 * Designates REST endpoints for http requests on {@link Policy} entity fields, using
 * {@link PolicyRepository} methods as the medium.
 */
@RestController
...
public class PolicyController {
  ...
  /**
   * Initializes this instance, injecting an instance of {@link PolicyRepository}, and
  ...
  /**
   * Adds a new instance of {@link Policy} to the database and returns an instance that include
  ...
  /**
   * Returns all of the instances of {@link Policy} that are between the dates in the given parameters.
  ...
  /**
   * Updates the startTime and EndTime of the {@link Policy} instance, fetched by the provide Id, with the provided parameters.
   * @param id UUID of the {@link Policy} instance.
   * @param modifiedPolicy partial instance of {@link Policy} which contains the modifications to be made.
