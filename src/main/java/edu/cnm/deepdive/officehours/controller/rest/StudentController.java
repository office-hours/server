...
/**
 * Designates REST endpoints for http requests on {@link Student} entity fields, using
 * {@link StudentRepository} operations as the medium.
 */
@RestController
...
public class StudentController {
  ...
  /**
   * Adds a new instance of {@link Student} to the database and returns an instance that include
   * the autogenerated id. The instance provided has to contain a valid UserId from the {@link User} entity,
   * a student name for this instance.
  ...
  /**
   * Returns all of the instances of {@link Student} that are on the database ordered by student name.
  ...
  /**
   * Updates the student name of the {@link Student} instance, fetched by the provide Id, with the provided parameter.
   * @param id UUID of the {@link Student} instance.
   * @param updated partial instance of {@link Student} which contains the modifications to be made.
  ...
  /** Returns a list of {@link Appointment} that is assigned to the {@link Student} with the
   * provided Id.
   * @param id UUID of the {@link Student} instance.
