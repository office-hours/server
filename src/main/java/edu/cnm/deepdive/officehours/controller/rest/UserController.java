...
/**
 * Designates REST endpoints for http requests on {@link User} entity fields, using
 * {@link UserRepository} operations as the medium.
 */
...
public class UserController {
 ...
 public UserController(UserRepository repository) {
   ...
   * the autogenerated fields such as timestamps, id. The instance provided has to contain a nickname,
   * oauth token, and email for this instance.
 ...
 public ResponseEntity<User> post(@RequestBody User user) {
  ...
  /**
   * Returns all of the instance of {@link User} that are on the database ordered by the redundant id.
 ...
 public User get(@PathVariable UUID id) {
  ...
  /**
   * Updates the email of the {@link User} instance, fetched by the provided Id, with the provided parameters.
   * @param id UUID of the {@link User} instance.
